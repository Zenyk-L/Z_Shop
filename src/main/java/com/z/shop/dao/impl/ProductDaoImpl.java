...
public class ProductDaoImpl implements ProductDao {
    ...
    private static String CREATE = "INSERT INTO z_shop.products (name, image, category, description, color, scale, price, adding_date) VALUES (?,?,?,?,?,?,?,?)";
    private static String READ_BY_ID = "SELECT * FROM z_shop.products WHERE id =? AND deleted = false";
    private static String UPDATE_BY_ID = "UPDATE z_shop.products SET name =?, image=?, category=?, description=?, color=?, scale=?, price=? WHERE id = ?";
    ...
    public Product read(Integer id) {
        ...
        try (Connection connection = ConnectionManager.getConnection();
            ...
            product = new Product(id, name, image, category, description, color, scale, price, date, deleted);
    ...
    public List<Product> readAll() {
        ...
        try (Connection connection = ConnectionManager.getConnection();
            ...
            while(resultSet.next()){
                ...
                productRecords.add(new Product(id, name, image, category, description, color, scale, price, date, deleted));
            }
